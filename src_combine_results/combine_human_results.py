...
def get_files():
    ...
    result_files = glob.glob(base_path + 'data_evaluation/human_results/classification_results/*')
    id_files = glob.glob(base_path + 'data_testing/manual_classification/8_shuffled/*')
    out_file  = base_path + 'data_combined_results/original/human_sentiment'

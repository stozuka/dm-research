...
def get_files():
    ...
    # in_files = glob.glob(base_path + 'data_system/testing/tokenized/minFreq_15_sentiment/*')
    # in_files = glob.glob(base_path + 'data_trigram/system_sentiment_more/*')
    in_files = glob.glob(base_path + 'data_trigram/system_sentiment/*')
    # out_file  = base_path + 'data_combined_results/original/system_sentiment'
    out_file  = base_path + 'data_combined_results/original/system_sentiment_trigram_test'

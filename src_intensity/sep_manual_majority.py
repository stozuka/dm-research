...
def get_files():
    ...
    manual_file = base_path + 'data_intensity/intensity_converted/majority'
    out_dir = base_path + 'data_intensity/sep_majority/manual_classification/'
...
def print_stats(result_dict, out_dir):
    out_file = '/'.join(out_dir.split('/')[:-3]) + '/sep_stats/majority'

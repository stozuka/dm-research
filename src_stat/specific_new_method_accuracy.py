...
def get_files():
    ...
    after_mean_2_emo_file = base_path + 'data_combined_results/new_approach_final/after_mean_2_first/std_600/mean1_1_8/mean2_1_7'

    out_file = base_path + 'data_stat_final/best_accuracy_each_emo'
...
def get_accuracy():
    ...
    system_emo_list = get_emo_list(system_emo_file, file_name='new_method')
